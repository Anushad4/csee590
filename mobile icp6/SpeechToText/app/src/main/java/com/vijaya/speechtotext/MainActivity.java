        ...
        tts = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    ...
                    tts.speak("Hello ANusha", TextToSpeech.QUEUE_FLUSH, null);
                    mVoiceInputTv.setText(Html.fromHtml("<p style=\"color:red;\">Speaker : Hello Anusha !!</p>"));
                }
            }
        });
            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        ...
                        if(result.get(0).equalsIgnoreCase("hello")) {
                        ...
                        }/*else if(result.get(0).contains("bob")){
                            ...
                            tts.speak("Hello Siri",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:red;\">Speaker :hello siri</p>"));
                        }
